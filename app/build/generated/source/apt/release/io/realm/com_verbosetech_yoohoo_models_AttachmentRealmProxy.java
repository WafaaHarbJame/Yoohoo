...
public class com_verbosetech_yoohoo_models_AttachmentRealmProxy extends com.verbosetech.yoohoo.models.Attachment
    ...
    public static com.verbosetech.yoohoo.models.Attachment copy(Realm realm, com.verbosetech.yoohoo.models.Attachment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface realmObjectCopy = (com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.verbosetech.yoohoo.models.Attachment object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$data = ((com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface) object).realmGet$data();
        if (realmGet$data != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dataIndex, rowIndex, realmGet$data, false);
        }
        String realmGet$url = ((com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlIndex, rowIndex, realmGet$url, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.bytesCountIndex, rowIndex, ((com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface) object).realmGet$bytesCount(), false);
        return rowIndex;
    }
    ...
    public static com.verbosetech.yoohoo.models.Attachment createDetachedCopy(com.verbosetech.yoohoo.models.Attachment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface realmSource = (com_verbosetech_yoohoo_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_verbosetech_yoohoo_models_AttachmentRealmProxy aAttachment = (com_verbosetech_yoohoo_models_AttachmentRealmProxy)o;
