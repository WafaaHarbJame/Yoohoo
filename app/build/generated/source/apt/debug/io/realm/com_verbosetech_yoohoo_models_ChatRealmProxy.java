...
public class com_verbosetech_yoohoo_models_ChatRealmProxy extends com.verbosetech1.yoohoo.models.Chat
        ...
        if (messagesList != null) {
            ...
            for (int i = 0; i < messagesList.size(); i++) {
                ...
                if (cachemessages != null) {
                    ...
                    messagesRealmList.add(com_verbosetech_yoohoo_models_MessageRealmProxy.copyOrUpdate(realm, messagesItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.verbosetech1.yoohoo.models.Chat object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$lastMessage = ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$chatId = ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdIndex, rowIndex, realmGet$chatId, false);
        }
        String realmGet$chatName = ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$chatName();
        if (realmGet$chatName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatNameIndex, rowIndex, realmGet$chatName, false);
        }
        String realmGet$chatImage = ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$chatImage();
        ...
        String realmGet$chatStatus = ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$chatStatus();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$read(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.groupIndex, rowIndex, ((com_verbosetech_yoohoo_models_ChatRealmProxyInterface) object).realmGet$group(), false);
        return rowIndex;
    }
    ...
    public static com.verbosetech1.yoohoo.models.Chat createDetachedCopy(com.verbosetech1.yoohoo.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_verbosetech_yoohoo_models_ChatRealmProxyInterface realmSource = (com_verbosetech_yoohoo_models_ChatRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_verbosetech_yoohoo_models_ChatRealmProxy aChat = (com_verbosetech_yoohoo_models_ChatRealmProxy)o;
