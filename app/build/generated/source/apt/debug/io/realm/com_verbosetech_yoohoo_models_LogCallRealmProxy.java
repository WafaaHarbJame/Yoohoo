...
public class com_verbosetech_yoohoo_models_LogCallRealmProxy extends com.verbosetech1.yoohoo.models.LogCall
    ...
    public static com.verbosetech1.yoohoo.models.LogCall copy(Realm realm, com.verbosetech1.yoohoo.models.LogCall newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_verbosetech_yoohoo_models_LogCallRealmProxyInterface realmObjectCopy = (com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.verbosetech1.yoohoo.models.LogCall object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeDurationSecondsIndex, rowIndex, ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$timeDurationSeconds(), false);
        String realmGet$status = ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$myId = ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$userName = ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameIndex, rowIndex, realmGet$userName, false);
        }
        String realmGet$userImage = ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$userImage();
        ...
        String realmGet$userStatus = ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$userStatus();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVideoIndex, rowIndex, ((com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) object).realmGet$isVideo(), false);
        return rowIndex;
    }
    ...
    public static com.verbosetech1.yoohoo.models.LogCall createDetachedCopy(com.verbosetech1.yoohoo.models.LogCall realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_verbosetech_yoohoo_models_LogCallRealmProxyInterface realmSource = (com_verbosetech_yoohoo_models_LogCallRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_verbosetech_yoohoo_models_LogCallRealmProxy aLogCall = (com_verbosetech_yoohoo_models_LogCallRealmProxy)o;
